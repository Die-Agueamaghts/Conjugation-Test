...
function renderConjugation(data) {
    ...
    for (const [mode, tenses] of Object.entries(data.modes || {})) {
        ...
        for (const [tense, forms] of Object.entries(tenses)) {
            ...
            headerRow.querySelector('.play-button').addEventListener('click', () => playSpeech(mode, tense, forms));
            headerRow.querySelector('.pause-button').addEventListener('click', () => pauseSpeech());
            headerRow.querySelector('.stop-button').addEventListener('click', () => stopSpeech());
